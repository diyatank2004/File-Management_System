                                    ...
                                    >
                                        <Box>
                                            ...
                                            <Typography variant="body2" sx={{ opacity: 0.8, mb: 3, lineHeight: 1.6 }}>
                                                Lexicon is a neural content engine built for the next generation of file management. It uses deep OCR and pattern recognition to make your data truly searchable.
                                            </Typography>
